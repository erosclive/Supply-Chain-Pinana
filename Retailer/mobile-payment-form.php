...
if (!isset($_POST['order_id']) || !isset($_POST['provider']) || !isset($_POST['reference']) || !isset($_POST['amount'])) {
...
try {
    ...
    // 2. Create payment record with mobile payment details
    ...
    $paymentStmt->bind_param("isdss", $order_id, $paymentMethod, $amount, $reference, $paymentNotes);
    ...
    $historyNotes = "Mobile payment processed via $provider. Amount: ₱" . number_format($amount, 2) . 
                   ". Reference: $reference";
    ...
    $response['message'] = "Mobile payment processed successfully";
