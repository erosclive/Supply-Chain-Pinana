document.addEventListener("DOMContentLoaded", () => {
  ...
  if (loginForm) {
    loginForm.addEventListener("submit", (e) => {
      ...
      // Show loading modal
      const loadingModal = document.getElementById("pineappleLoadingModal")
              ...
              if (data.success) {
                ...
                if (data.accountStatus) {
                  switch (data.accountStatus) {
                    case "pending":
                      window.location.href = "account_status.html?status=pending"
                      break
                    case "rejected":
                      window.location.href = "account_status.html?status=rejected"
                      break
                    default:
                  ...
                  window.location.href = "verification_required.php?email=" + encodeURIComponent(data.email)
                } else {
                  // Show error message
                  alert(data.message || "Login failed. Please check your credentials.")
                }
